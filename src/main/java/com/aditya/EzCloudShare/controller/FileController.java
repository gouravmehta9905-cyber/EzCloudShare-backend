...
import com.aditya.EzCloudShare.dto.FileMetadataDTO;
import com.aditya.EzCloudShare.service.FileMetadataService;
...
public class FileController {
    ...
    public ResponseEntity<Resource> download(@PathVariable String id) throws IOException {
        FileMetadataDTO downloadbleFile=fileMetadataService.getDownloadFile(id);
